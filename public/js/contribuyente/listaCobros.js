...
//Servicios
const newcservice = $("#tableDataServicios").DataTable(optionsTableDefault);

new $.fn.dataTable.Responsive(newcs);

const tableBodyServicios = document.getElementById("tableBodyServicios");
...
function viewServices(data) {
  ...
  $("#tableDataServicios").DataTable().destroy();

  tableBodyServicios.innerHTML = html;

  const newcservices = $("#tableDataServicios").DataTable(optionsTableDefault);

  new $.fn.dataTable.Responsive(newcservices);
}
