...
function renderResumenCaja() {
    ...
    .then(data => {
        ...
        ingresos_caja_fisica.textContent = parseFloat(data.ingresosFisicos).toFixed(2);
        egresos_caja_fisica.textContent = parseFloat(data.egresosFisicos).toFixed(2);
        utilidad_fisica.textContent = parseFloat(data.utilidadFisica).toFixed(2);

        ingresos_caja_virtual.textContent = parseFloat(data.ingresosVirtual).toFixed(2);
        egresos_caja_virtual.textContent = parseFloat(data.egresosVirtual).toFixed(2);
        utilidad_virtual.textContent = parseFloat(data.utilidadVirtual).toFixed(2);
