                        ...
                        <div class="chat-action-col">
                          ...
                          >
                            ...
                            <a href="#" class="dropdown-item reply-button"
                              ><span><i class="bx bx-share"></i></span>Responder</a
                            >
                            <a href="#" class="dropdown-item"
                              ><span><i class="bx bx-smile"></i></span>Reaccionar</a
                            >
                            <a
                              href="#"
                              class="dropdown-item"
                            ...
                            <a href="#" class="dropdown-item click-star"
                              ...
                              ><span class="star-msg">Mensaje Estrella</span></a
                            >
                            <a
                              href="#"
                              class="dropdown-item"
                              ...
                              ><span><i class="bx bx-trash"></i></span>Eliminar</a
                            >
                          </div>
                        </div>
                      </div>
            ...
            <form>
              ...
              <div class="replay-forms">
                <div class="chats forward-chat-msg reply-div d-none">
                  ...
                  <div class="chat-content">
                    <div class="chat-profile-name">
                      <h6>Usuario de Prueba<span>8:16 PM</span></h6>
                      <div class="chat-action-btns ms-2">
                        <div class="chat-action-col">
                          <a class="#" href="#" data-bs-toggle="dropdown">
                            <i class="bx bx-dots-horizontal-rounded"></i>
...
//https://0e39c1f7-8417-4e86-a00d-049a119b5820-00-3hr8kq7du963g.picard.replit.dev/send-template

//Para consultar las plantillas
//https://graph.facebook.com/v22.0/108260089008765/message_templates
//enviar el TOKEN

//Para consultar una plantilla en especifica
//https://graph.facebook.com/v21.0/108260089008765/message_templates?name=recordatorio_honorario_renta&access_token=<TOKEN>
