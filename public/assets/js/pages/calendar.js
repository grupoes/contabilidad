(function () {
  ...
  let trabajadorSeleccionado = document.getElementById("trabajadorId").value;
    ...
    document.getElementById("calendar"),
    {
      ...
      select: function (info) {
        ...
        document.getElementById("pc-e-btn-text").innerHTML =
          '<i class="align-text-bottom me-1 ti ti-calendar-plus"></i> Agregar';
        document
          .querySelector("#pc_event_add")
          .setAttribute("data-pc-action", "add");

        document.getElementById("calendar-add_event-title").innerHTML =
          "Agregar Actividad";
      ...
      eventClick: function (info) {
        ...
        var dias_notificar =
          clickedevent.extendedProps.dias_notificar === undefined
            ? ""
            : clickedevent.extendedProps.dias_notificar;
        var horas_notificar =
          clickedevent.extendedProps.horas_notificar === undefined
            ? ""
            : clickedevent.extendedProps.horas_notificar;

        if (dias_notificar > 0) {
          document.querySelector(".pc-event-notificar").innerHTML =
            dias_notificar + " días";
        } else {
          document.querySelector(".pc-event-notificar").innerHTML =
            horas_notificar + " horas";
        }
      ...
      events: function (info, successCallback, failureCallback) {
        ...
        fetch("agenda/getAgenda?" + params.toString()) // URL de tu endpoint
  ...
  if (pc_event_edit) {
    pc_event_edit.addEventListener("click", function (event) {
      ...
      document.getElementById("pc-e-btn-text").innerHTML =
        '<i class="align-text-bottom me-1 ti ti-calendar-stats"></i> Editar';
      document
        .querySelector("#pc_event_add")
  ...
  document
    .getElementById("trabajadorId")
    .addEventListener("change", function () {
      trabajadorSeleccionado = this.value;
