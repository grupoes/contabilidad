            ...
            <form id="formDatos" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <input type="hidden" name="staCorreo" id="staCorreo" value="0">
                            <label class="form-label" for="correo">Correo Electrónico</label>
                            <input type="email" class="form-control" name="correo" id="correo" required>
                        </div>
                        <div class="col-md-4 mb-3">
                            <input type="hidden" name="staUser" id="staUser" value="0">
                        ...
                        <div class="col-md-6">
                            <div class="mt-3">
                                <input type="hidden" name="path" id="path" value="<?= base_url('assets/images/user/avatar-2.jpg') ?>">
