<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from dreamschat.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jul 2024 22:31:59 GMT -->
...
<head>
    ...
    <title>Whatsapp ES</title>

    <link rel="icon" href="assets/chat/img/grupoes.ico" />

    <link rel="stylesheet" href="assets/chat/css/bootstrap.min.css" />

    <link rel="stylesheet" href="assets/chat/css/feather.css" />

    <link
        rel="stylesheet"
        href="assets/chat/plugins/fontawesome/css/fontawesome.min.css" />
    <link rel="stylesheet" href="assets/chat/plugins/fontawesome/css/all.min.css" />

    <link rel="stylesheet" href="assets/chat/plugins/swiper/swiper.min.css" />

    <link
        rel="stylesheet"
        href="assets/chat/plugins/fancybox/jquery.fancybox.min.css" />

    <link
        rel="stylesheet"
        href="assets/chat/plugins/boxicons/css/boxicons.min.css" />

    <link rel="stylesheet" href="assets/chat/plugins/select2/css/select2.min.css" />

    <link rel="stylesheet" href="assets/chat/css/app.css" />
</head>
...
<body>
    <div class="main-wrapper">
        <div class="content main_content">
            <div class="sidebar-menu">
                <div class="logo-col">
                    <a href="index.html"><img src="assets/chat/img/logo_es.png" alt="Logo" /></a>
                </div>
                <div class="menus-col">
                            ...
                            <li>
                                <div class="avatar avatar-online">
                                    <a
                                        ...
                                        <img src="assets/chat/img/avatar/avatar-2.jpg" alt />
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="settings.html" class="dropdown-item"><span><i class="bx bx-cog"></i></span>Settings</a>
                                        <a href="email-login.html" class="dropdown-item"><span><i class="bx bx-log-out"></i></span>Logout
                                        </a>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="">
                        <div>
                            <div
                                ...
                                <div class="select-group-chat">
                                    <div class="dropdown">
                                        <a
                                            ...
                                            data-bs-toggle="dropdown">
                                            Whatsapp ES<i class="bx bx-chevron-down"></i>
                                        </a>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="chat.html">Todos</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="archive-chat.html">Chat Archivos</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="pinned-chat.html">Chat Fijados</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div
                                    class="icon-no-leido"
                                    style="position: relative; width: 30px; text-align: center">
                                    <a href="#" title="Todos">
                                ...
                                <div
                                    class="icon-no-leido"
                                    style="position: relative; width: 30px; text-align: center">
                                    <a href="#" title="No leídos">
                                        <i class="fas fa-eye-slash"></i>
                                        <!--<span
                                            class="badge bg-primary pc-h-badge"
                                            style="
                          position: absolute;
                          width: 20px;
                          height: 20px;
                        ...
                        ">3</span>-->
                                                ...
                                                <div class="chat-action-col">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a
                                                            ...
                                                            class="dropdown-item"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#new-group"><span><i class="bx bx-user-circle"></i></span>Create Group</a>
                                                        <a
                                                            href="javascript:;"
                                                            class="dropdown-item"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#invite-other"><span><i class="bx bx-user-plus"></i></span>Invite Others</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                            ...
                            <div class="" style="margin: 24px 24px 0px">
                                <div
                                    class="search_chat has-search"
                        ...
                        <div class="sidebar-body chat-body slimscroll" id="chatsidebar">
                            <ul class="user-list">
                        ...
                        <form action="#">
                                    ...
                                    <ul class="user-list">
                                        <li class="user-list-item">
                                            <div class="list-user-blk">
                                                <div class="avatar">
                                                    <img
                                                        src="assets/chat/img/avatar/avatar-4.jpg"
                                        ...
                                        <li class="user-list-item">
                                            <div class="list-user-blk">
                                                <div class="avatar">
                                                    <img
                                                        src="assets/chat/img/avatar/avatar-5.jpg"
                                                        class="rounded-circle"
                                                        alt="image" />
                                                </div>
                                                <div class="users-list-body">
                                    ...
                                    <ul class="user-list">
                                        <li class="user-list-item">
                                            <div class="list-user-blk">
                                                <div class="avatar">
                                                    <img
                                                        src="assets/chat/img/avatar/avatar-10.jpg"
                                                        class="rounded-circle"
                                                        alt="image" />
                                                </div>
                                                <div class="users-list-body">
                                        ...
                                        <li class="user-list-item">
                                            <div class="list-user-blk">
                                                <div class="avatar">
                                                    <img
                                                        src="assets/chat/img/avatar/avatar-12.jpg"
                                                        class="rounded-circle"
                                                        alt="image" />
                                                </div>
                                                <div class="users-list-body">
                            ...
                            <div class="mute-chat-btn">
                                ...
                                <button
                                    ...
                                    aria-label="Close">
                                    <img
                                        src="assets/chat/img/icon/send.svg"
                                        class="me-1"
                                        alt="image" />Chat
                                </button>
                            </div>
                                    ...
                                    <div class="profile-cover text-center">
                                        <label class="profile-cover-avatar" for="avatar_upload">
                                            ...
                                            <span class="avatar-edit">
                                                <img src="assets/chat/img/icon/camera.svg" alt="Image" />
                                            </span>
                                        </label>
                                    </div>
                ...
                <div class="modal-content success-group-wrap-list">
                    <div class="modal-header">
                        <div class="success-pass mx-auto">
                            <img
                                src="assets/chat/img/avatar/avatar-16.png"
                                alt="Success"
                                class="img-fluid" />
                        </div>
                    </div>
        ...
        <div class="modal fade mute-notify" id="mute-notification">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Mute Notifications</h5>
                        <button
                            type="button"
                            class="close"
                            data-bs-dismiss="modal"
    ...
    <script
        src="assets/chat/js/jquery-3.7.0.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/js/bootstrap.bundle.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/plugins/slimscroll/jquery.slimscroll.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/plugins/swiper/swiper.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/plugins/fancybox/jquery.fancybox.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/plugins/select2/js/select2.min.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script
        src="assets/chat/js/script.js"
        type="dfde92322b74b2bb39d64f3a-text/javascript"></script>

    <script src="assets/chat/js/chat.js"></script>
    <script
        src="assets/chat/cloudflare-static/rocket-loader.min.js"
        data-cf-settings="dfde92322b74b2bb39d64f3a-|49"
        defer></script>
</body>

<!-- Mirrored from dreamschat.dreamstechnologies.com/html/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Jul 2024 22:32:00 GMT -->
