...
$routes->get('api/mensajes', 'Api\Notificaciones::getMensajes');
$routes->get('api/mensaje/(:num)/envios', 'Api\Notificaciones::getEnviosByMensaje/$1');
$routes->post('api/crear-mensaje', 'Api\Notificaciones::crearMensaje');
$routes->post('api/crear-envio', 'Api\Notificaciones::crearEnvio');
...
$routes->get('api/comunicacion-baja/download-all', 'Api\Notificaciones::downloadAllCdrsComunicacionBaja');
$routes->get('api/comunicacion-baja/download/(:num)', 'Api\Notificaciones::downloadCdrComunicacionBaja/$1');
